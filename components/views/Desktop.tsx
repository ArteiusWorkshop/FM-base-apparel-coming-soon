...
export const Desktop = () => {
  return (
    <Box display="flex" width="100vw" height="100vh" left="0" top="0">
      <Box
        width="60vw"
        height="100vh"
        display="flex"
      ...
      >
        <Box>
          ...
          <Box pt={12}>
            <Typography variant="h1" className="titles pink">
              We&#39;re
            </Typography>
            <Typography variant="h1" className="titles">
              coming
            </Typography>
            <Typography variant="h1" className="titles">
              soon
          ...
          <Box pb={4}>
            <Typography className="para">
              Hello fellow shoppers! W&#39;re currently building our new fashion
      ...
      >
        <img src="/img/hero-desktop.jpg" className="hero" alt="Hero Image" />
      </Box>
    </Box>
  );
};
